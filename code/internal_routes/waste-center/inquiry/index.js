...
// const Inquiries = require("../../databases/business/inquiry");
...
// const tags = {
//                 'clumsy':'aamrk33@gmail.com',
//                 'reiki':'drsurabhi.reiki@gmail.com',
...
//         //console.log(i);
// 	if(i){
//         	await sendMessage(tags["clumsy"],{subject:"You Have recieved a new inquiry",text:"From: "+name+"\nPhone:"+phone+"\nEmail: "+email+"\nMessaage: "+message},'email');
//         	ret.status = "success";
...
// router.get("/one/:inquiry_id",performValidationPanel,async function(req,res){
